var CircularProgressBar = function() {
    ...
    return function t(i) {
        ...
        e(this, "initial", (function(e) {
            if ("IntersectionObserver"in window) {
                var t = 0
                  , n = new IntersectionObserver((function(e, n) {
                    e.forEach((function(e) {
                        e.isIntersecting && e.intersectionRatio > .75 && (o.createSvg(e.target, t),
        ...
        e(this, "progressBar", (function(e, t, r) {
            ...
            g.setAttribute("stroke", l ? "url(#linear-".concat(i, ")") : u);
            ...
            if (c) {
                ...
                if (!(i > 100 || i < 0 || a === i)) {
                    var u, d = t ? 0 : a, p = function e() {
                        ...
                        c.setAttribute("stroke-dasharray", 2.64 * d + ", 20000"),
                        l && s.number && (l.textContent = "".concat(d, "%")),
                        d === i && (c.setAttribute("data-angel", d),
        ...
        e(this, "createSvg", (function(e, t) {
            ...
            o.setAttr(a, s, !1),
            c.colorCircle && a.appendChild(o.circleSvg(c, "bottom")),
            c.lineargradient && a.appendChild(o.gradient(c)),
            a.appendChild(o.circleSvg(c, "top", !0)),
            e.appendChild(a),
            o.progressBar(a, e, c)
        }
        )),
        ...
        e(this, "setAttr", (function(e, t) {
            ...
            for (var r in t)
                n ? e.setAttributeNS(null, r, t[r]) : e.setAttribute(r, t[r])
        }
        )),
        this.pieName = i,
        this.pieElement = document.querySelectorAll(".".concat(i)),
